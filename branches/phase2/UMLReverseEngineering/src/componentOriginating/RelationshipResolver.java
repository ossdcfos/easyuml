...
//YET TO BE IMPLEMENTED
     ...
     */
    public static ComponentBase selectDefinitiveComponent(String componentName) {
        ...
        Set<ComponentBase> set = CompilationProcessor.generatedDiagram.getComponents();
        List<ComponentBase> foundElementsInDiagramComponent = new ArrayList<>();
        for (ComponentBase component : set) {
            if (component.getName().startsWith(componentClasName)) {
                foundElementsInDiagramComponent.add(component);
            }
        }
     ...
     * @return true if the relationship already exists inside Class diagram
     * component's hash map of all relations, false if it does not
     */
