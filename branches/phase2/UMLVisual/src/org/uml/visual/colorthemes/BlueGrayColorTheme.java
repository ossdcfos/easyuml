 ...
 * @author Boris
 */
public class BlueGrayColorTheme implements ColorTheme {

    // Component - colors
    private static final float BASIC_ALPHA = 0.20f;
    protected static final Color BASIC_COLOR = new Color(0xFFE0E0E0, true);
    ...
    protected static final Color HOVER_BORDER_COLOR = new Color(0xFF0000D0, true);
