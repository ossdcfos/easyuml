...
//                null);
    ...
    public void accept(Widget widget, Point point, Transferable t) {
        ...
        try {
            ...
            if (ClassDiagramComponent.class.isAssignableFrom(droppedComponentClass)) {
...
//            classDiagramScene.getView().addMouseListener(new MouseAdapterZaView(editorAction));
            } else if (RelationComponent.class.isAssignableFrom(droppedComponentClass)) {
                ...
                for (int i = 0; i < dialog.getRelationComponents().getItemCount(); i++) {
                    RelationComponent selectedComponent = dialog.getRelationComponents().getItemAt(i);
                ...
                throw new RuntimeException("Unknown dropped component: "+cobj.getClass()+"!");
            }
