 ...
 * @author Ilija
 * @see
 * http://grepcode.com/file/repo1.maven.org/maven2/com.googlecode.sarasvati.thirdparty.netbeans/visual/7.3/org/netbeans/modules/visual/anchor/ArrowAnchorShape.java#ArrowAnchorShape
 * @see
 * http://www.javaprogrammingforums.com/object-oriented-programming/10461-java-graphics-drawing-one-object-into-another.html
 */
public class RhombusAnchorShape implements AnchorShape {
    ...
    public RhombusAnchorShape(int degrees, int size, boolean filled) {
        this.size = size;
